...
import axios from 'axios';
 ...
 class approverPendingWorkflow extends Component {
    state={
        schools:null,
        spinner:true
    }
    ...
    createTable=()=>{
        ...
        for(let i=0;i<this.state.schools.length;i++){
            ...
            if(this.state.schools[i].schoolStatus==="REVIEWER_APPROVED_QUOTATION"){
...
export default withRouter(approverPendingWorkflow);
